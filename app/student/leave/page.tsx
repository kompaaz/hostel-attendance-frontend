    ...
    return (
        <div className="min-h-screen bg-gray-100 py-8 px-4">
            <div className="w-full max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-6 md:p-8 font-mono">
                ...
                >
                    <h3 className="text-xl font-semibold text-black mb-4">Apply for Leave</h3>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block font-medium text-gray-800 mb-2">From Date</label>
                            <input
                                type="date"
                                value={fromDate}
                        ...
                        <div>
                            <label className="block font-medium text-gray-800 mb-2">To Date</label>
                            <input
                                type="date"
                                value={toDate}
                    ...
                    <div>
                        <label className="block font-medium text-gray-800 mb-2">Reason</label>
                        <textarea
                            value={reason}
                ...
                {/* Leave History */}
                <div className="mb-8">
                    <h3 className="text-xl font-semibold mb-4 text-black">My Leave Requests</h3>
                    ...
                    {requests.length > 0 ? (
                        ...
                        <div className="text-center py-8 bg-gray-50 rounded-lg">
                            ...
                            <p className="text-sm text-gray-400 mt-2">Apply for your first leave above.</p>
                        </div>
                    )}
                </div>
